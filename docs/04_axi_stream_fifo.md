# Traffic Queuing & Buffering (`axi_stream_fifo.v`)
...
To differentiate between these states in hardware without complex mathematical division, engineers use the **N+1 Pointer Trick**, which the architecture will explore in the code section.
...
The architecture was designed a **Synchronous FIFO** (single `clk` pin).
